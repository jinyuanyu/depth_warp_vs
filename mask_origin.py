...
if __name__ == "__main__":
    exit(main())
#python mask_origin.py       --rgb /root/Warp/mask_test/frame_200.png       --depth /root/Warp/mask_test/depth_200.png       --output /root/Warp/mask_results_basic/       --manual_K "1402.1,1402.1,968.77,506.154"       --focus_depth 5.9       --img_size "1080,1920"       --num_per_side 2       --max_disp_px 25       --temperature 30.0       --occlusion hard       --channels_last       --rescale_depth linear 